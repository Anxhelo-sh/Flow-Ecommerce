    ...
    <div class="max-w-screen-xl px-4 py-12 mx-auto sm:px-6 lg:px-8">
      ...
      >
        ...
        <div class="lg:col-span-3">
          ...
          <div class="grid grid-cols-1 gap-px mt-4  border border-gray-200 sm:grid-cols-2 lg:grid-cols-3" v-for="product in  $page.props.products " :key="product.id">
            <a class="block" href="/product">
              <img
                  class="object-cover w-full h-[3450px] sm:h-[450px]"
